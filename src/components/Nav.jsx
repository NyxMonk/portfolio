      ...
      <header
        ...
        <nav className="container-edit flex items-center justify-between h-20 md:h-24">
          ...
          <div className="hidden md:block">
            <a
              href="https://drive.google.com/file/d/1tJsG7U6bjqbcSIAReGTWovRKFZ3BAnw2/view?usp=sharing"
              className="text-[15px] tracking-[0.04em] text-stone hover:text-ink transition-colors duration-300"
            >
              Resume
            </a>
          ...
          >
            <ul className="container-edit flex flex-col gap-6">
              ...
              <motion.li
                ...
                className="pt-4"
              >
                <a href="https://drive.google.com/file/d/1tJsG7U6bjqbcSIAReGTWovRKFZ3BAnw2/view?usp=sharing" className="text-lg text-stone">
                  Resume
                </a>
              </motion.li>
            </ul>
